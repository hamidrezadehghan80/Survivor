...
import {post_image, Who_to_follow_avatar} from "../../Constants/images";
...
const Thread_post = ({post_id, name, username, date, user_img, post_text, post_img, like_num, comment_num}) => {
    return(
        <Grid
            container
            flexDirection={"row"}
